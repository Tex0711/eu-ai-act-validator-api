...
{\Huge\textbf{TECHNISCHE SPECIFICATIE}}
...
{\large\textbf{i-DEPOT Indiening}}

\vspace{1cm}

\begin{tabular}{ll}
\textbf{Document Type:} & Technische Specificatie (Intellectueel Eigendom) \\
\textbf{Versie:} & 1.0 \\
\textbf{Datum:} & 31 januari 2026 \\
\textbf{Auteur:} & ComplianceCode.eu \\
\textbf{Status:} & Confidentieel \\
\end{tabular}

\vspace{2cm}

{\large\textbf{BESCHERMD INNOVATIE CONCEPT}}

\vspace{0.5cm}

Dit document beschrijft de innovatieve "Article-Specific Filtering" methode \\
voor realtime EU AI Act compliance verificatie middels client-side \\
cosine similarity berekeningen op semantische vector embeddings.

\vspace{1cm}

{\footnotesize © 2026 ComplianceCode.eu. Alle rechten voorbehouden.}
